            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-4 col-md-2">
                        <img id="profile-image" src="{{ (Auth::user()->profile_image==null) ? asset('assets/frontend/images/no-image.jpg') : asset('storage/'.Auth::user()->profile_image) }}"
                            class="mb-1 rounded float-start avater-image" alt="...">
                    </div>
                    <div class="col-8 col-md-10">
                        <h4>{{ Auth::user()->name }}</h4>
                        <p>{{ Auth::user()->email }}</p>
                        <form action="" id="profie-img-upload" class="d-flex align-items-center" enctype="multipart/form-data" method="post">
                            @csrf
                            <p class="mb-0 me-3"><label for="profile_image" class="link-unstyled btn btn-sm rounded bg-lavender"><input type="file" name="profile_image" hidden id="profile_image"><img width="20" height="20" src="https://img.icons8.com/fluency/48/pencil-tip.png" alt="pencil-tip"/>&nbsp;Change picture</a></p>
                            <button type="submit" id="btn-image-save" class="btn btn-sm btn-primary d-block d-none">Save</button>
                        </form>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body p-0">
                                <form method="post" id="personal-details-form">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="d-inline-block btn btn-primary float-end">Save</button>
                                    </div>
